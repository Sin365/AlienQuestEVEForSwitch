public class AI_Mon_21 : global::UnityEngine.MonoBehaviour
{
	...
	private void Update()
	{
		...
		else
		{
			...
			if (GM.GameOver && GetComponent<Monster>().Gameover_Num == 0 && global::UnityEngine.Mathf.Abs(Player.transform.position.x - base.transform.position.x) < 9f + rnd_X)
			{
				Check_Idle();
				return;
			}
			...
			base.transform.Translate(global::UnityEngine.Vector3.right * global::UnityEngine.Time.deltaTime * 16f * facingRight * GetComponent<Monster>().Move_Speed);
		}
	}

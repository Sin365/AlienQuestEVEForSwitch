	...
	private void Start()
	{
		...
		if (global::UnityEngine.GameObject.Find("GameOver_Manager") != null)
		{
			...
			if (UnityEngine.Camera.main.GetComponent<GameOver_Camera>() != null)
			{
				...
				UnityEngine.Camera.main.transform.position = new global::UnityEngine.Vector3(-1f, 0.5f, -10f);
				UnityEngine.Camera.main.GetComponent<GameOver_Camera>().Set_TargetPos(new global::UnityEngine.Vector3(-1f, 0.5f, -10f));
			}
		}
		else
		{
			...
			if (UnityEngine.Camera.main.GetComponent<Gallery_Camera>() != null)
			{
				...
				UnityEngine.Camera.main.transform.position = new global::UnityEngine.Vector3(-1f, 0.5f, -10f);
				UnityEngine.Camera.main.GetComponent<Gallery_Camera>().Set_TargetPos(new global::UnityEngine.Vector3(-1f, 0.5f, -10f));
			}
		}

...
public class AI_Mon_40 : global::UnityEngine.MonoBehaviour
{
	...
	private void Update()
	{
		...
		if (event_Type != AI_Mon_40.Event_Type.None)
		{
			...
			{
				onEvent_Sound = true;
				GameManager.instance.sc_Sound_List.Mon_40_Dash(pos_Orig);
			}
		...
		if (distance < 50f && (GM.GameOver || GM.onHscene))
		{
			if (GM.Hscene_Num == 0 && GM.Hscene_Timer <= 0f)
			{
				...
				dist_X = global::UnityEngine.Mathf.Abs(GM.gobj_Pos_Down_Center.transform.position.x - base.transform.position.x);
				...
				{
					Pos_Target = new global::UnityEngine.Vector3(GM.gobj_Pos_Down_Center.transform.position.x, Player.transform.position.y + 6.4f, 0f);
			...
			else if (Patrol_State == 1)
			{
				...
				Pos_Target = new global::UnityEngine.Vector3(GM.gobj_Pos_Down_Center.transform.position.x + (Patrol_Range + 10f) * (float)facingRight, Player.transform.position.y + 7.5f - Rnd_XY.y * 3f, 0f);
	...
	private void Dash()
	{
		...
		if (onCam_Timer <= 0f)
		{
			...
			GameManager.instance.sc_Sound_List.Mon_Atk_2(Pos_Target);
			GameManager.instance.sc_Sound_List.Mon_9_Growling(Pos_Target);
			GameManager.instance.sc_Sound_List.HiddenPassage(Pos_Target);
		}
		else
		{
			...
			GameManager.instance.sc_Sound_List.HiddenPassage(base.transform.position);
		}
	}
	...
	private void Set_Fire()
	{
		...
		global::UnityEngine.GameObject gameObject2 = AxiObject.Instantiate(_Fire, pos_Fire.position, global::UnityEngine.Quaternion.Euler(0f, 0f, angle + 20f)) as global::UnityEngine.GameObject;
		global::UnityEngine.GameObject gameObject3 = AxiObject.Instantiate(_Fire, pos_Fire.position, global::UnityEngine.Quaternion.Euler(0f, 0f, angle - 20f)) as global::UnityEngine.GameObject;
		global::UnityEngine.GameObject gameObject4 = AxiObject.Instantiate(_Fire, pos_Fire.position, global::UnityEngine.Quaternion.Euler(0f, 0f, angle + 40f)) as global::UnityEngine.GameObject;
		global::UnityEngine.GameObject gameObject5 = AxiObject.Instantiate(_Fire, pos_Fire.position, global::UnityEngine.Quaternion.Euler(0f, 0f, angle - 40f)) as global::UnityEngine.GameObject;

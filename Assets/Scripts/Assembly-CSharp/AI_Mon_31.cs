...
public class AI_Mon_31 : global::UnityEngine.MonoBehaviour
{
	...
	public AI_Mon_31.Event_Type event_Type;
	...
	private void Start()
	{
		...
		if (event_Type != AI_Mon_31.Event_Type.None)
		{
			Event_Start();
		}
	...
	private void Event_Start()
	{
		...
		Mon.isLockHit = true;
		Flip_Delay = 0f;
		if (event_Type == AI_Mon_31.Event_Type.Top)
		{
		...
		{
			GetComponent<Mon_Index>().Xenomorph_Layer(19);
			on_Event_Scale = true;
			GetComponent<global::UnityEngine.BoxCollider2D>().enabled = false;
	...
	private void Event_End()
	{
		if (event_Type != AI_Mon_31.Event_Type.None)
		{
			event_Type = AI_Mon_31.Event_Type.None;
	...
	private void Update()
	{
		...
		else if (event_Type == AI_Mon_31.Event_Type.None && Mon.isLockHit)
		{
			Mon.isLockHit = false;
		}
		Raycasting();
		...
		else if (event_Type == AI_Mon_31.Event_Type.None && animator.speed < 1f)
		{
			animator.speed = 1f;
		}
		if (on_Event_Rotate)
		...
		else if (event_Type == AI_Mon_31.Event_Type.None && !GetComponent<global::UnityEngine.BoxCollider2D>().enabled)
		{
			GetComponent<global::UnityEngine.BoxCollider2D>().enabled = true;
		}
		if (event_Type != AI_Mon_31.Event_Type.None)

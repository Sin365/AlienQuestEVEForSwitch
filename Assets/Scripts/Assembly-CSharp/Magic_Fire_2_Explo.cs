public class Magic_Fire_2_Explo : global::UnityEngine.MonoBehaviour
{
	...
	private void OnTriggerStay2D(global::UnityEngine.Collider2D col)
	{
		...
		if (!GM.GameOver && !GM.onHscene && !GM.onDown && GM.Damage_Timer <= 0f && !onColPlayer && col.name == "Ani")
		{
			...
			global::UnityEngine.GameObject.Find("Player").rigidbody2D.velocity = new global::UnityEngine.Vector2(0f, 0f);
			int num = ((!(base.transform.position.x > col.transform.position.x)) ? 1 : (-1));
			global::UnityEngine.GameObject.Find("Player").rigidbody2D.AddForce(global::UnityEngine.Vector3.right * num * 20f, global::UnityEngine.ForceMode2D.Impulse);
			if (col.transform.position.y > base.transform.position.y)
			{
				global::UnityEngine.GameObject.Find("Player").rigidbody2D.AddForce(global::UnityEngine.Vector3.up * 20f, global::UnityEngine.ForceMode2D.Impulse);
			}
		}

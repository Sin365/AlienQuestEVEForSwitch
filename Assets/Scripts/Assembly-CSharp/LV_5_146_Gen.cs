    ...
    private void Start()
	{
		...
		if (GM.Get_Event(3) && GM.Check_EventMonster(9))
		{
			if (Pos_40_List.Length > 0)
			{
				...
				{
					global::UnityEngine.GameObject gameObject = AxiObject.Instantiate(_Mon_40, Pos_40_List[i].position, base.transform.rotation) as global::UnityEngine.GameObject;
			...
			if (Pos_41 != null)
			{
				global::UnityEngine.GameObject gameObject2 = AxiObject.Instantiate(_Mon_41, Pos_41.position, base.transform.rotation) as global::UnityEngine.GameObject;
		...
		if (Pos_30_List.Length > 0)
		{
			...
			{
				global::UnityEngine.GameObject gameObject3 = AxiObject.Instantiate(_Mon_30, Pos_30_List[j].position, base.transform.rotation) as global::UnityEngine.GameObject;
		...
		if (Pos_38_List.Length > 0)
		{
			...
			{
				global::UnityEngine.GameObject gameObject4 = AxiObject.Instantiate(_Mon_38, Pos_38_List[k].position, base.transform.rotation) as global::UnityEngine.GameObject;

public class H_GameOver_2 : global::UnityEngine.MonoBehaviour
{
	...
	private void Start()
	{
		...
		if (global::UnityEngine.GameObject.Find("GameOver_Manager") != null)
		{
			...
			{
				UnityEngine.Camera.main.GetComponent<GameOver_Camera>().Cam_Top = 10f;
				UnityEngine.Camera.main.GetComponent<GameOver_Camera>().Cam_Bot = -10f;
				...
				UnityEngine.Camera.main.transform.position = new global::UnityEngine.Vector3(0f, 0.8f, -10f);
				UnityEngine.Camera.main.GetComponent<GameOver_Camera>().Set_TargetPos(new global::UnityEngine.Vector3(0f, 0.8f, -10f));
			}
		}
		else
		{
			...
			{
				UnityEngine.Camera.main.GetComponent<Gallery_Camera>().Cam_Top = 10f;
				UnityEngine.Camera.main.GetComponent<Gallery_Camera>().Cam_Bot = -10f;
				...
				UnityEngine.Camera.main.transform.position = new global::UnityEngine.Vector3(0f, 0.8f, -10f);
				UnityEngine.Camera.main.GetComponent<Gallery_Camera>().Set_TargetPos(new global::UnityEngine.Vector3(0f, 0.8f, -10f));
			}
		}
	...
	private void Cum_Hold()
	{
		if (color_Cum_1.a > 0f && Cum_Rnd_Timer <= 0f)
		{
			...
			{
				global::UnityEngine.GameObject gameObject = AxiObject.Instantiate(CumShot[global::UnityEngine.Random.Range(1, 6)], pos_Penis_C.position, global::UnityEngine.Quaternion.Euler(0f, 0f, 90f)) as global::UnityEngine.GameObject;
			...
			{
				global::UnityEngine.GameObject gameObject2 = AxiObject.Instantiate(CumShot[global::UnityEngine.Random.Range(2, 6)], pos_Mouth.position, global::UnityEngine.Quaternion.Euler(0f, 0f, 90f)) as global::UnityEngine.GameObject;

public class LV_5_143_Gen : global::UnityEngine.MonoBehaviour
{
    ...
    private void Start()
	{
		...
		if (Pos_30_List.Length > 0)
		{
			...
			{
				global::UnityEngine.GameObject gameObject2 = AxiObject.Instantiate(_Mon_30, Pos_30_List[j].position, base.transform.rotation) as global::UnityEngine.GameObject;
		...
		if (Pos_38_List.Length > 0)
		{
			...
			{
				global::UnityEngine.GameObject gameObject3 = AxiObject.Instantiate(_Mon_38, Pos_38_List[k].position, base.transform.rotation) as global::UnityEngine.GameObject;
		...
		if (Pos_41 != null)
		{
			global::UnityEngine.GameObject gameObject4 = AxiObject.Instantiate(_Mon_41, Pos_41.position, base.transform.rotation) as global::UnityEngine.GameObject;

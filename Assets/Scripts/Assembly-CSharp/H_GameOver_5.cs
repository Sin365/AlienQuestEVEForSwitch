public class H_GameOver_5 : global::UnityEngine.MonoBehaviour
{
	...
	private void Start()
	{
		...
		if (global::UnityEngine.GameObject.Find("GameOver_Manager") != null)
		{
			...
			{
				global::UnityEngine.GameObject.Find("Main Camera").GetComponent<GameOver_Camera>().Cam_Top = 12f;
				global::UnityEngine.GameObject.Find("Main Camera").GetComponent<GameOver_Camera>().Cam_Bot = -8f;
				...
				global::UnityEngine.GameObject.Find("Main Camera").transform.position = new global::UnityEngine.Vector3(0f, 0.5f, -10f);
				global::UnityEngine.GameObject.Find("Main Camera").GetComponent<GameOver_Camera>().Set_TargetPos(new global::UnityEngine.Vector3(0f, 0.5f, -10f));
			}
		}
		else
		{
			...
			if (global::UnityEngine.GameObject.Find("Main Camera").GetComponent<Gallery_Camera>() != null)
			{
				...
				global::UnityEngine.GameObject.Find("Main Camera").transform.position = new global::UnityEngine.Vector3(0f, 0.5f, -10f);
				global::UnityEngine.GameObject.Find("Main Camera").GetComponent<Gallery_Camera>().Set_TargetPos(new global::UnityEngine.Vector3(0f, 0.5f, -10f));
			}
		}

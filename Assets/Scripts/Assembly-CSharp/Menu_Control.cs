...
public class Menu_Control : global::UnityEngine.MonoBehaviour
{
    ...
    {
        get { return mMenu_State; }
        set
        {
            if (mMenu_State != value)
            {
                if (value == 0)//切换到地图
                {
                    rect_Pos_Menu_0.gameObject.SetActive(true);
                    GameManager.instance.MC.gameObject.SetActive(true);
#if UNITY_EDITOR
                    Debug.Log("[Menu]切换到地图");
#endif
                }
                else if (mMenu_State == 0)//离开地图页签
                {
                    rect_Pos_Menu_0.gameObject.SetActive(false);
                    GameManager.instance.MC.gameObject.SetActive(false);
#if UNITY_EDITOR
                    Debug.Log("[Menu]离开地图页签");
#endif
                }

                if (value == 1)//切换到角色菜单
                {
                    rect_Pos_Menu_1.gameObject.SetActive(true);
#if UNITY_EDITOR
                    Debug.Log("[Menu]切换到角色菜单");
#endif
                }
                else if (mMenu_State == 1)//离开角色菜单
                {
                    rect_Pos_Menu_1.gameObject.SetActive(false);
#if UNITY_EDITOR
                    Debug.Log("[Menu]离开角色菜单");
#endif
                }

                if (value == 2)//切换到设置菜单
                {
                    rect_Pos_Menu_2.gameObject.SetActive(true);
#if UNITY_EDITOR
                    Debug.Log("[Menu]切换到设置菜单");
#endif
                }
                else if (mMenu_State == 2)//离开设置菜单
                {
                    rect_Pos_Menu_2.gameObject.SetActive(false);
#if UNITY_EDITOR
                    Debug.Log("[Menu]离开设置菜单");
#endif
                }

                if (value == 3)//[Menu]切换到按键菜单
                {
                    rect_Pos_Menu_3.gameObject.SetActive(true);
#if UNITY_EDITOR
                    Debug.Log("[Menu]切换到按键菜单");
#endif
                }
                else if (mMenu_State == 3)//离开按键菜单
                {
                    rect_Pos_Menu_3.gameObject.SetActive(false);
#if UNITY_EDITOR
                    Debug.Log("[Menu]离开按键菜单");
#endif
                }

                if (value == 4)//[Menu]切换到退出菜单
                {
                    rect_Pos_Menu_4.gameObject.SetActive(true);
#if UNITY_EDITOR
                    Debug.Log("[Menu]切换到退出菜单");
#endif
                }
                else if (mMenu_State == 4)//离开退出菜单
                {
                    rect_Pos_Menu_4.gameObject.SetActive(false);
#if UNITY_EDITOR
                    Debug.Log("[Menu]离开退出菜单");
#endif
                }
            }
            mMenu_State = value;
    ...
    private Camera camera_UI_Camera;
    private RectTransform rect_Pos_Menu_0;
    private RectTransform rect_Pos_Menu_1;
    private RectTransform rect_Pos_Menu_2;
    private RectTransform rect_Pos_Menu_3;
    private RectTransform rect_Pos_Menu_4;
    private RectTransform rect_Select_BG;
    private RectTransform rect_Select_Cursor;
    private Dictionary<int, RectTransform> rect_pos_OptArr = new Dictionary<int, RectTransform>();
    private RectTransform rect_Map_Grid;
    private RectTransform rect_MapPos_Cursor;
    ...
    private RectTransform rect_Map_GunShip;
    private GameObject gobj_MissionBriefing;
    private RectTransform rect_Ellen_MapCursor;
    private Image img_Sound_Bar;
    private Image img_Music_Bar;
    private RectTransform rect_SelBorder_BGM;
    private RectTransform rect_SelBorder_Window;
    private RectTransform rect_SelBorder_Censorship;
    private RectTransform rect_SelBorder_Hscene;
    private RectTransform rect_SelBorder_HealthBar;
    private Image img_Select_KeyConfig;
    private Text txt_Text_AssignedKey;

    private void Start()
    {
        //预先find
        camera_UI_Camera = GameObject.Find("UI Camera").GetComponent<Camera>();
        rect_Pos_Menu_0 = GameObject.Find("Pos_Menu_0").GetComponent<RectTransform>();
        rect_Pos_Menu_1 = GameObject.Find("Pos_Menu_1").GetComponent<RectTransform>();
        rect_Pos_Menu_2 = GameObject.Find("Pos_Menu_2").GetComponent<RectTransform>();
        rect_Pos_Menu_3 = GameObject.Find("Pos_Menu_3").GetComponent<RectTransform>();
        rect_Pos_Menu_4 = GameObject.Find("Pos_Menu_4").GetComponent<RectTransform>();

        rect_Select_BG = GameObject.Find("Select_BG").GetComponent<RectTransform>();
        rect_Select_Cursor = GameObject.Find("Select_Cursor").GetComponent<RectTransform>();
        for (int i = 1; i <= 18; i++) {
            rect_pos_OptArr[i] = GameObject.Find("pos_Opt" + i).GetComponent<RectTransform>();
        }
        rect_Map_Grid = GameObject.Find("Map_Grid").GetComponent<RectTransform>();
        rect_MapPos_Cursor = GameObject.Find("MapPos_Cursor").GetComponent<RectTransform>();
        rect_Mission_1 = GameObject.Find("Mission_1").GetComponent<RectTransform>();
        rect_Mission_2 = GameObject.Find("Mission_2").GetComponent<RectTransform>();
        rect_Mission_3 = GameObject.Find("Mission_3").GetComponent<RectTransform>();
        rect_Mission_4 = GameObject.Find("Mission_4").GetComponent<RectTransform>();
        rect_Map_GunShip = GameObject.Find("Map_GunShip").GetComponent<RectTransform>();
        gobj_MissionBriefing = GameObject.Find("MissionBriefing");
        rect_Ellen_MapCursor = GameObject.Find("Ellen_MapCursor").GetComponent<RectTransform>();

        img_Sound_Bar = GameObject.Find("Sound_Bar").GetComponent<Image>();
        img_Music_Bar = GameObject.Find("Music_Bar").GetComponent<Image>();
        rect_SelBorder_BGM = GameObject.Find("SelBorder_BGM").GetComponent<RectTransform>();
        rect_SelBorder_Window = GameObject.Find("SelBorder_Window").GetComponent<RectTransform>();
        rect_SelBorder_Censorship = GameObject.Find("SelBorder_Censorship").GetComponent<RectTransform>();
        rect_SelBorder_Hscene = GameObject.Find("SelBorder_Hscene").GetComponent<RectTransform>();
        rect_SelBorder_HealthBar = GameObject.Find("SelBorder_HealthBar").GetComponent<RectTransform>();
        img_Select_KeyConfig = GameObject.Find("Select_KeyConfig").GetComponent<Image>();
        txt_Text_AssignedKey = GameObject.Find("Text_AssignedKey").GetComponent<Text>();
        /////
        ...
        //	rect_Mission_4.sizeDelta = new global::UnityEngine.Vector2(300f, 60f);
        //}
    ...
    private void Update()
    {
        ...
        if (GM.onHscene && !GM.GameOver)
        {
            ...
            else if (AxiInputBridge.GetAxis("L_Trigger") > 0f)
            {
                inputX = 1f;
            }
            else if (AxiInputBridge.GetAxis("L_Trigger") < 0f)
        ...
        else
        {
            ...
            if (GM.Paused)
            {
                ...
                if (onKeyConfigBox)
                {
                    ...
                    img_Select_KeyConfig.color = new global::UnityEngine.Color(1f, 1f, 1f, KeyBox_Opacity);
                    txt_Text_AssignedKey.color = new global::UnityEngine.Color(1f, 1f, 1f, KeyBox_Opacity);
                    if (AxiInputBridge.GetKeyDown(global::UnityEngine.KeyCode.Escape) || AxiInputBridge.GetButtonDown("Start") || AxiInputBridge.GetButtonDown("_B") || AxiInputBridge.GetMouseButtonDown(0) || AxiInputBridge.GetMouseButtonDown(1))
                    {
                ...
                if (Menu_State == 0)
                {
                    ...
                    rect_Ellen_MapCursor.localScale = new global::UnityEngine.Vector3(SelCursor_Size, SelCursor_Size, 1f);
                    if (GM.EventState == 200)
                    {
                        rect_Mission_4.localPosition = new global::UnityEngine.Vector3(-1050f, 300f + global::UnityEngine.Mathf.Sin(SelCursor_Timer * 8f) * 5f, 1f);
                    }
                }
                ...
                else if (Menu_State == 2)
                {
                    ...
                    else if (Sel_Index == 1 && (AxiInputBridge.GetKey(global::UnityEngine.KeyCode.LeftArrow) || AxiInputBridge.GetAxis("L_X") < 0f))
                    {
                        Set_Sound(-1, 0f);
                    }
                    else if (Sel_Index == 1 && (AxiInputBridge.GetKey(global::UnityEngine.KeyCode.RightArrow) || AxiInputBridge.GetAxis("L_X") > 0f))
                    {
                        Set_Sound(1, 0f);
                    }
                    else if (Sel_Index == 2 && (AxiInputBridge.GetKey(global::UnityEngine.KeyCode.LeftArrow) || AxiInputBridge.GetAxis("L_X") < 0f))
                    {
                        Set_Music(-1, 0f);
                    }
                    else if (Sel_Index == 2 && (AxiInputBridge.GetKey(global::UnityEngine.KeyCode.RightArrow) || AxiInputBridge.GetAxis("L_X") > 0f))
                    {
                        Set_Music(1, 0f);
                    }
                    Check_SoundArrow();
                ...
                if (Menu_State > 0)
                {
                    ...
                    rect_Select_Cursor.position = global::UnityEngine.Vector3.Lerp(rect_Select_Cursor.position, PosTarget, global::UnityEngine.Time.deltaTime * 16f);
                    SelCursor_Timer += global::UnityEngine.Time.deltaTime;
                    SelCursor_Size = 1f + (1f + global::UnityEngine.Mathf.Sin(SelCursor_Timer * 10f)) * 0.05f;
                    if (rect_Select_Cursor.sizeDelta.x > 150f)
                    {
                        SelCursor_Size = 1f + (1f + global::UnityEngine.Mathf.Sin(SelCursor_Timer * 10f)) * 0.015f;
                    }
                    rect_Select_Cursor.localScale = new global::UnityEngine.Vector3(SelCursor_Size, SelCursor_Size, 1f);
                    if (SelBG_Opacity < 1f)
                    {
                ...
                if (AxiInputBridge.GetKeyDown(CK.Jump) || AxiInputBridge.GetButtonDown("Jump"))
                {
                    if (Menu_State == 1)
                    {
                ...
                else if (AxiInputBridge.GetKeyDown(global::UnityEngine.KeyCode.Escape) || AxiInputBridge.GetButtonDown("Start") || AxiInputBridge.GetButtonDown("_B"))
                {
                    Off_Menu();
                }
                if (StatSel_Num != 0 && StatSel_Num == Sel_Index && (AxiInputBridge.GetKey(CK.Jump) || AxiInputBridge.GetButton("Jump")))
                {
            ...
            else if (!GM.onSave && !GM.onTeleport && (AxiInputBridge.GetKeyDown(global::UnityEngine.KeyCode.Escape) || AxiInputBridge.GetButtonDown("Start")) && GM.resumeTimer <= 0f)
            {
                On_Menu();
            }
        }
        ...
        if (Menu_State != 0)
        {
            if (Menu_State == 1)
            {
                if (Sel_Index < 0)
                {
                    ...
                    rect_Select_Cursor.sizeDelta = new global::UnityEngine.Vector2(70f, 70f);
                    rect_Select_BG.sizeDelta = new global::UnityEngine.Vector2(366f, 60f);
                    rect_Select_BG.position = PosTarget;
                    rect_Select_BG.position = new global::UnityEngine.Vector3(PosTarget.x - 1.65f, PosTarget.y, PosTarget.z);
                }
                else if (Sel_Index > 0)
                {
                    PosTarget = global::UnityEngine.GameObject.Find("pos_B" + Sel_Index).GetComponent<global::UnityEngine.RectTransform>().position;
                    rect_Select_Cursor.sizeDelta = new global::UnityEngine.Vector2(92f, 92f);
                    rect_Select_BG.sizeDelta = new global::UnityEngine.Vector2(76f, 76f);
                    rect_Select_BG.position = PosTarget;
                }
            }
            else if (Menu_State == 2)
            {
                ...
                if (Sel_Index <= 2)
                {
                    PosTarget = rect_pos_OptArr[Sel_Index].position;
                    rect_Select_Cursor.sizeDelta = new global::UnityEngine.Vector2(420f, 90f);
                    rect_Select_BG.sizeDelta = new global::UnityEngine.Vector2(404f, 76f);
                }
                else if (Sel_Index < 10)
                {
                    PosTarget = rect_pos_OptArr[Sel_Index].position;
                ...
                {
                    PosTarget = rect_pos_OptArr[Sel_Index].position;
                    rect_Select_Cursor.sizeDelta = new global::UnityEngine.Vector2(290f, 92f);
                    rect_Select_BG.sizeDelta = new global::UnityEngine.Vector2(275f, 76f);
                }
                else if (Sel_Index < 18)
                {
                    PosTarget = rect_pos_OptArr[Sel_Index].position;
                    rect_Select_Cursor.sizeDelta = new global::UnityEngine.Vector2(100f, 70f);
                    rect_Select_BG.sizeDelta = new global::UnityEngine.Vector2(78f, 48f);
                }
                else
                {
                    PosTarget = rect_pos_OptArr[18].position;
                    rect_Select_Cursor.sizeDelta = new global::UnityEngine.Vector2(157f, 70f);
                    rect_Select_BG.sizeDelta = new global::UnityEngine.Vector2(130f, 42f);
                }
                rect_Select_BG.position = PosTarget;
            }
            else if (Menu_State == 3)
            {
                ...
                if (Sel_Index < 9 || Sel_Index == 11)
                {
                    ...
                    rect_Select_Cursor.sizeDelta = new global::UnityEngine.Vector2(450f, 60f);
                    rect_Select_BG.sizeDelta = new global::UnityEngine.Vector2(426f, 36f);
                }
                else if (Sel_Index < 11)
                {
                    PosTarget = global::UnityEngine.GameObject.Find("pos_Kcfg" + Sel_Index).GetComponent<global::UnityEngine.RectTransform>().position;
                    rect_Select_Cursor.sizeDelta = new global::UnityEngine.Vector2(450f, 80f);
                    rect_Select_BG.sizeDelta = new global::UnityEngine.Vector2(426f, 56f);
                }
                else
                {
            ...
            else if (Menu_State == 4)
            {
                ...
                rect_Select_Cursor.sizeDelta = new global::UnityEngine.Vector2(196f, 66f);
                rect_Select_BG.sizeDelta = new global::UnityEngine.Vector2(180f, 50f);
                rect_Select_BG.position = PosTarget;
            }
        }
        SelBG_Opacity = 0f;
    ...
    private void Change_Menu()
    {
        ...
        rect_Pos_Menu_0.localPosition = new global::UnityEngine.Vector3(0f, 2000f, 0f);
        rect_Pos_Menu_1.localPosition = new global::UnityEngine.Vector3(0f, 2000f, 0f);
        rect_Pos_Menu_2.localPosition = new global::UnityEngine.Vector3(0f, 2000f, 0f);
        rect_Pos_Menu_3.localPosition = new global::UnityEngine.Vector3(0f, 2000f, 0f);
        rect_Pos_Menu_4.localPosition = new global::UnityEngine.Vector3(0f, 2000f, 0f);
        ...
        if (Menu_State == 0)
        {
            ...
            GM.rect_MC.localPosition = new global::UnityEngine.Vector3(rect_Pos_Menu_0.localPosition.x + 325f, rect_Pos_Menu_0.localPosition.y, 0f);
            GM.rect_MC.localScale = new global::UnityEngine.Vector3(0.22f, 0.22f, 1f);
            rect_Map_Grid.localPosition = new global::UnityEngine.Vector3(8000f, 0f, 0f);
            rect_MapPos_Cursor.localScale = new global::UnityEngine.Vector3(3f, 3f, 1f);
            rect_Mission_1.localScale = new global::UnityEngine.Vector3(2.5f, 2.5f, 1f);
            rect_Mission_2.localScale = new global::UnityEngine.Vector3(2.5f, 2.5f, 1f);
            rect_Mission_3.localScale = new global::UnityEngine.Vector3(2.5f, 2.5f, 1f);
            if (GM.EventState < 200)
            {
            ...
            {
                rect_Mission_4.localScale = new global::UnityEngine.Vector3(3f, 3f, 1f);
            }
            rect_Mission_4.localPosition = new global::UnityEngine.Vector3(-1050f, 300f, 1f);
            if (GM.Room_Num > 0)
            {
                rect_Map_GunShip.localScale = new global::UnityEngine.Vector3(2f, 2f, 1f);
            }
            else
            {
                rect_Map_GunShip.localScale = new global::UnityEngine.Vector3(0f, 0f, 0f);
            }
            gobj_MissionBriefing.SendMessage("Set_BriefingPos_Menu");
        }
        else
        {
            ...
            rect_Map_Grid.localPosition = new global::UnityEngine.Vector3(0f, 0f, 0f);
            rect_MapPos_Cursor.localScale = new global::UnityEngine.Vector3(1f, 1f, 1f);
            rect_Mission_1.localScale = new global::UnityEngine.Vector3(1f, 1f, 1f);
            rect_Mission_2.localScale = new global::UnityEngine.Vector3(1f, 1f, 1f);
            rect_Mission_3.localScale = new global::UnityEngine.Vector3(1f, 1f, 1f);
            if (GM.EventState < 200)
            {
                rect_Mission_4.localScale = new global::UnityEngine.Vector3(0f, 0f, 0f);
            }
            ...
            rect_Mission_4.localPosition = new global::UnityEngine.Vector3(-1050f, 170f, 1f);
            rect_Map_GunShip.localScale = new global::UnityEngine.Vector3(1f, 1f, 1f);
            gobj_MissionBriefing.SendMessage("Hide_BriefingPos");
        }
    }

    private void Check_LRB()
    {
        if ((AxiInputBridge.GetButtonDown("L_B") || AxiInputBridge.GetKeyDown(CK.LB)) && Menu_State > 0)
        {
            Menu_State--;
            Change_Menu();
        }
        else if ((AxiInputBridge.GetButtonDown("R_B") || AxiInputBridge.GetKeyDown(CK.RB)) && Menu_State < 4)
        {
            Menu_State++;
            Change_Menu();
        }
    ...
    private void Check_Mouse()
    {
        ...
        {
            global::UnityEngine.Ray ray = camera_UI_Camera.ScreenPointToRay(AxiInputBridge.mousePosition);
            ...
            if (rayIntersection.collider != null)
			{
                ...
                else if (Menu_State == 2)
                {
                    ...
                    {
                        float posMouse = (camera_UI_Camera.ScreenToWorldPoint(AxiInputBridge.mousePosition).x - global::UnityEngine.GameObject.Find("pos_SoundBarMin").GetComponent<global::UnityEngine.RectTransform>().position.x) / (global::UnityEngine.GameObject.Find("pos_SoundBarMax").GetComponent<global::UnityEngine.RectTransform>().position.x - global::UnityEngine.GameObject.Find("pos_SoundBarMin").GetComponent<global::UnityEngine.RectTransform>().position.x);
                        Set_Sound(0, posMouse);
                    }
                    else if (rayIntersection_collider == "pos_Opt2")
                    {
                        float posMouse2 = (camera_UI_Camera.ScreenToWorldPoint(AxiInputBridge.mousePosition).x - global::UnityEngine.GameObject.Find("pos_MusicBarMin").GetComponent<global::UnityEngine.RectTransform>().position.x) / (global::UnityEngine.GameObject.Find("pos_MusicBarMax").GetComponent<global::UnityEngine.RectTransform>().position.x - global::UnityEngine.GameObject.Find("pos_MusicBarMin").GetComponent<global::UnityEngine.RectTransform>().position.x);
        ...
        {
            global::UnityEngine.Ray ray2 = camera_UI_Camera.ScreenPointToRay(AxiInputBridge.mousePosition);
            ...
            if (rayIntersection2.collider != null)
			{
                ...
                {
                    if (AxiInputBridge.GetMouseButton(0) && rayIntersection2_collider == "pos_Opt1")
                    {
                        if (Sel_Index == 1)
                        {
                            Sel_Index = 1;
                        }
                        float posMouse3 = (camera_UI_Camera.ScreenToWorldPoint(AxiInputBridge.mousePosition).x - global::UnityEngine.GameObject.Find("pos_SoundBarMin").GetComponent<global::UnityEngine.RectTransform>().position.x) / (global::UnityEngine.GameObject.Find("pos_SoundBarMax").GetComponent<global::UnityEngine.RectTransform>().position.x - global::UnityEngine.GameObject.Find("pos_SoundBarMin").GetComponent<global::UnityEngine.RectTransform>().position.x);
                        Set_Sound(0, posMouse3);
                    }
                    else if (AxiInputBridge.GetMouseButton(0) && rayIntersection2_collider == "pos_Opt2")
                    {
                        if (Sel_Index == 1)
                        {
                            Sel_Index = 1;
                        }
                        float posMouse4 = (camera_UI_Camera.ScreenToWorldPoint(AxiInputBridge.mousePosition).x - global::UnityEngine.GameObject.Find("pos_MusicBarMin").GetComponent<global::UnityEngine.RectTransform>().position.x) / (global::UnityEngine.GameObject.Find("pos_MusicBarMax").GetComponent<global::UnityEngine.RectTransform>().position.x - global::UnityEngine.GameObject.Find("pos_MusicBarMin").GetComponent<global::UnityEngine.RectTransform>().position.x);
        ...
        if (!flag || AxiInputBridge.GetMouseButtonUp(0))
        {
            StatPush_Timer = 0f;
        }
    }
    ...
    {
        img_Sound_Bar.fillAmount = GM.Option_Volume[0];
        img_Music_Bar.fillAmount = GM.Option_Volume[1];
        rect_SelBorder_BGM.localPosition = rect_pos_OptArr[(3 + GM.Option_Int[0])].localPosition;
        rect_SelBorder_Window.localPosition = rect_pos_OptArr[(9 + GM.Option_Int[1])].localPosition;
        rect_SelBorder_Censorship.localPosition = rect_pos_OptArr[(11 + GM.Option_Int[2])].localPosition;
        rect_SelBorder_Hscene.localPosition = rect_pos_OptArr[(13 + GM.Option_Int[3])].localPosition;
        rect_SelBorder_HealthBar.localPosition = rect_pos_OptArr[(15 + GM.Option_Int[4])].localPosition;
    }
    ...
    private void Select_Hscene(int num)
    {
        GM.Option_Int[3] = num;
        Sound_List.SendMessage("Sound_Tab");
        rect_SelBorder_Hscene.localPosition = rect_pos_OptArr[(13 + num)].localPosition;
    ...
    private void Select_HealthBar(int num)
    {
        GM.Option_Int[4] = num;
        Sound_List.SendMessage("Sound_Tab");
        rect_SelBorder_HealthBar.localPosition = rect_pos_OptArr[(15 + num)].localPosition;
    ...
    private void On_KeyBox(int num)
    {
        ...
        txt_Text_AssignedKey.text = global::UnityEngine.GameObject.Find("KeyAssigned_" + num).GetComponent<global::UnityEngine.UI.Text>().text;
    }

    private void Check_KeyConfig()
    {
        img_Select_KeyConfig.color = new global::UnityEngine.Color(1f, 1f, 1f, 0f);
        txt_Text_AssignedKey.color = new global::UnityEngine.Color(1f, 1f, 1f, 0f);
    }

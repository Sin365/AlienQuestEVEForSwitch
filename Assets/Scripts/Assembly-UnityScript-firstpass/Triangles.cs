...
public class Triangles : global::UnityEngine.MonoBehaviour
{
	...
	public static global::UnityEngine.Mesh GetMesh(int triCount, int triOffset, int totalWidth, int totalHeight)
	{
		...
		global::UnityEngine.Vector3[] array = new global::UnityEngine.Vector3[triCount * 3];
		global::UnityEngine.Vector2[] array2 = new global::UnityEngine.Vector2[triCount * 3];
		global::UnityEngine.Vector2[] array3 = new global::UnityEngine.Vector2[triCount * 3];
		...
		for (int i = 0; i < triCount; i++)
		{
			...
			float num4 = global::UnityEngine.Mathf.Floor(num3 % totalWidth) / (float)totalWidth;
			float num5 = global::UnityEngine.Mathf.Floor(num3 / totalWidth) / (float)totalHeight;
			global::UnityEngine.Vector3 vector = new global::UnityEngine.Vector3(num4 * 2f - 1f, num5 * 2f - 1f, 1f);
			array[num2 + 0] = vector;
			array[num2 + 1] = vector;
			array[num2 + 2] = vector;
			...
			array3[num2 + 0] = new global::UnityEngine.Vector2(num4, num5);
			array3[num2 + 1] = new global::UnityEngine.Vector2(num4, num5);
			array3[num2 + 2] = new global::UnityEngine.Vector2(num4, num5);
